...
El plan inicial consideraba **24 h**. Las ampliaciones con estimación adicional documentada suman actualmente **8.5 h** (`CH-001` + `CH-002` + `CH-006`), por lo que la referencia planificada revisada es **32.5 h**. Esto no equivale a tiempo real consumido: el tiempo real sigue sin estar consolidado y no se infiere.
