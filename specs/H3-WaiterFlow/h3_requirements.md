...
| H3-R05 | Agregar productos mediante una operación de servidor que obtenga `producto.precio`, lo copie a `precio_unitario` y cree obligatoriamente el detalle en estado `ABIERTO`, sin aceptar precio ni estado decididos por el cliente. | Must |
