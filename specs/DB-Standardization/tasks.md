...
| DBSTD-T02 | Crear una migración nueva que redefina las tres RPC H6 para usar `obtener_contexto_autenticado()`, preservando firma, retornos, roles, filtros y orden para contextos válidos, y aplicando el rechazo aprobado `42501 / No autorizado` para contextos inválidos. | T01, D01–D02 | No queda resolución directa duplicada de perfil/rol ni retorno silencioso por contexto inválido en esas tres funciones. | TP01–TP12 |
