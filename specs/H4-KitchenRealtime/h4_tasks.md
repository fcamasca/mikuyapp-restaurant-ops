...
Todas las tareas están pendientes. No iniciar construcción hasta que `requirements.md`, `design.md`, `tasks.md` y `test-plan.md` sean aprobados humanamente.

## Plan de construcción propuesto

| Estado | ID | Tarea | Diseño | Requisitos | Est. h |
|---|---|---|---|---|---:|
| [ ] | H4-T01 | Crear cambio mínimo de modelo para `detalle_pedido.enviado_en`, backfill compatible, constraint e índice de antigüedad; adaptar el envío existente para fijar el timestamp en servidor una sola vez. | H4-D01, H4-D05 | H4-R03, H4-R10 | 0.75 |
...
| [ ] | H4-T06 | Construir ruta y tablero de cocina con agrupación por pedido/mesa, antigüedad, tiempo, estados y acciones táctiles. | H4-D02, H4-D03, H4-D07, H4-D10 | H4-R01–H4-R04, H4-R07, H4-R14 | 1.25 |
