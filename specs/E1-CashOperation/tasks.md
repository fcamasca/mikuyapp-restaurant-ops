...
**E1-T01 y E1-T02 (Spec Mode)** quedan completadas documentalmente. E1-T03 en adelante son trabajo propuesto, no autorizado y no iniciado. La impresión de comandas se trasladó a Evolución 7 y no forma parte de estas tareas.
...
| E1-T03 | Diseñar y migrar `caja`/`sesion_caja`, datos mínimos de caja y estrategia legacy, sin tocar migraciones históricas. | T02, PM-002 DEV disponible | Integridad, unicidad de sesión abierta, FKs y comentarios aprobados. | R01–R03 / TP01–TP08 | 4 h |
| E1-T04 | Implementar RPC/RLS/grants de apertura, recuperación compartida de sesión activa e histórico básico. | T03 | Una sesión abierta por caja; cualquier `CAJA` activo del local puede continuarla y cada operación conserva actor. | R01–R03/R08 / TP03–TP12 | 3 h |
