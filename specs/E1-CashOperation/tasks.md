...
La referencia histórica de **30–40 horas** se conserva intacta. T01 (4 h) y T02 (2 h) suman **6 h de Spec Mode completado**; T03–T14 conservan sus **53 h**, T15 añade **6 h** y T16 suma **12 h** (`8 h` de base + `4 h` del delta de flujo actual). La construcción aprobada suma **71 h** y el total con Spec Mode asciende a **77 h**.
