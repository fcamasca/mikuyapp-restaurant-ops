...
| E1-T10 | **Completada técnicamente, incluido delta TP62.** Adaptar Caja para componer N medios dentro de un cobro normal/parcial, mostrar faltante/exceso y confirmar el acto una sola vez; mantener las demás capacidades existentes. | Delta T09 + lecturas agrupadas | Cobro normal cubre saldo completo; parcial es acto separado; confirmación/resync/documentos consumen snapshot servidor. Evidencia en `implementation-t10.md`. | R13–R18/R22 / TP32–TP48, TP59–TP60 aplicables | 7 h |
