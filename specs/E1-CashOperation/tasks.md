...
**E1-T01 y E1-T02 (Spec Mode)** quedan completadas documentalmente. La construcción autorizada alcanzó **T03–T10**: T03–T09 fueron validadas en PostgreSQL local aislado y T10 quedó validada técnicamente en frontend sobre sus lecturas autoritativas. T11–T14 siguen pendientes. La homologación aprobada de TP03/TP04 conserva D03: una apertura sobre una caja ya abierta recupera la sesión vigente sin error funcional. Esto no implica aceptación de E1. La impresión de comandas se trasladó a Evolución 7 y no forma parte de estas tareas.
