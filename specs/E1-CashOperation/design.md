...
E1 incorpora únicamente este snapshot actual no persistido. E8 conserva históricos, series, tendencias, comparaciones entre periodos/locales, metas/SLA, productividad, rankings, análisis de cuellos de botella, productos más vendidos y demás analítica. El diseño prioriza acciones vigentes y estado actual sobre densidad de indicadores. T16 está construida y validada técnicamente; el acceso `Operación → Pedidos` queda como T17 pendiente de aprobación humana de este delta antes de construcción. TP62–TP64 permanecen abiertos.
