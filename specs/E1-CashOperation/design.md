...
E1 incorpora únicamente este snapshot actual no persistido. E8 conserva históricos, series, tendencias, comparaciones entre periodos/locales, metas/SLA, productividad, rankings, análisis de cuellos de botella, productos más vendidos y demás analítica. El diseño prioriza acciones vigentes y estado actual sobre densidad de indicadores. La base de T16 está construida; esta ampliación documental requiere aprobación humana antes de continuar construcción.
