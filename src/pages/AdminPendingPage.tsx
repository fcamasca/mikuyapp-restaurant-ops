...
export default function AdminPendingPage({ context }: { readonly context: ValidatedProfileContext }) {
  return <main className="mx-auto max-w-6xl px-3 py-5 sm:px-6 sm:py-7">
    ...
    <p className="mt-2 text-sm text-stone-600">Revisa y decide las solicitudes de descuento pendientes del local. Los cierres con diferencia se consultan desde Inicio o Caja y nunca requieren aprobación.</p>
