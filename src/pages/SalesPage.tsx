...
export default function SalesPage({ context, embedded = false, isSigningOut, mode = 'all', onBack, onSignOut }: { readonly context: ValidatedProfileContext; readonly embedded?: boolean; readonly isSigningOut: boolean; readonly mode?: 'all' | 'cash' | 'sales'; readonly onBack: () => void; readonly onSignOut: () => void }) {
